...
execute as @e[tag=pot_marker,tag=!pot_marker_item_set] at @s if data block ~ ~ ~ {item:{}} unless data block ~ ~ ~ {item:{id:"minecraft:decorated_pot"}} run function enhanced_pots:setup_pot_inventory with block ~ ~ ~ item
...
# pot fully cleared
execute as @e[tag=pot_marker,tag=pot_marker_item_set] at @s unless data block ~ ~ ~ {item:{}} if score @s enhanced_pots.item_count matches 1 run say "pot fully cleared"
...
execute as @e[tag=pot_marker,tag=pot_marker_item_set] at @s unless data block ~ ~ ~ {item:{}} unless score @s enhanced_pots.item_count matches 1 run say "item removed from pot"
execute as @e[tag=pot_marker,tag=pot_marker_item_set] at @s unless data block ~ ~ ~ {item:{}} unless score @s enhanced_pots.item_count matches 1 run function enhanced_pots:item_removed